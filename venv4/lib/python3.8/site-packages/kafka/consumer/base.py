...
from kafka.errors import UnknownTopicOrPartitionError, check_error, KafkaError
    ...
    * APIs for fetching pending message count
    ...
    def commit(self, partitions=None):
        ...
        with self.commit_lock:
            ...
            log.debug(
                "Committing new offsets for %s, partitions %s", self.topic, partitions
            )
            for partition in partitions:
                ...
                reqs.append(
                    OffsetCommitRequestPayload(self.topic, partition, offset, None)
                )
