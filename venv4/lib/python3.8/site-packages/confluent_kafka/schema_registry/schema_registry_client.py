...
class _RestClient(object):
    ...
    def __init__(self, conf):
        ...
        if not isinstance(base_url, string_type):
            raise TypeError(
                "url must be an instance of str, not " + str(type(base_url))
            )
...
class SchemaRegistryClient(object):
    ...
    def register_schema(self, subject_name, schema):
        ...
        response = self._rest_client.post(
            "subjects/{}/versions".format(_urlencode(subject_name)), body=request
        )
    ...
    def lookup_schema(self, subject_name, schema):
        ...
        response = self._rest_client.post(
            "subjects/{}".format(_urlencode(subject_name)), body=request
        )
        ...
        return RegisteredSchema(
            schema_id=response["id"],
            schema=Schema(
                response["schema"], schema_type, response.get("references", [])
            ),
    ...
    def delete_subject(self, subject_name):
        ...
        """  # noqa: E501
        return self._rest_client.delete("subjects/{}".format(_urlencode(subject_name)))
    ...
    def get_latest_version(self, subject_name):
        ...
        response = self._rest_client.get(
            "subjects/{}/versions/{}".format(_urlencode(subject_name), "latest")
        )
...
class Schema(object):
    ...
    def __eq__(self, other):
        return all(
            [self.schema_str == other.schema_str, self.schema_type == other.schema_type]
        )
